...
use metfor::{Meters, HectoPascal, Celsius, WindSpdDir};
...
fn create_valid_test_sounding() -> Sounding {
    ...
    Sounding::new()
        .with_station_info(StationInfo::new_with_values(1, (45.0, -115.0), Meters(1023.0)))
        ...
        .with_pressure_profile(
            ...
            vec![
                Optioned::from(WindSpdDir{ direction: 0.0, speed_kt: 5.0}),
                Optioned::from(WindSpdDir{ direction: 40.0, speed_kt: 10.0}),
                Optioned::from(WindSpdDir{ direction: 80.0, speed_kt: 15.0}),
                Optioned::from(WindSpdDir{ direction: 120.0, speed_kt: 12.0}),
                Optioned::from(WindSpdDir{ direction: 160.0, speed_kt: 27.0}),
                Optioned::from(WindSpdDir{ direction: 200.0, speed_kt: 45.0}),
                Optioned::from(WindSpdDir{ direction: 240.0, speed_kt: 62.0}),
                Optioned::from(WindSpdDir{ direction: 280.0, speed_kt: 80.0}),
            ],
        ).with_height_profile(
            vec![
        ...
        .with_sfc_wind(WindSpdDir{speed_kt: 0.0, direction: 0.0})
}
...
fn create_invalid_test_invalid_negative_value() -> Sounding {
    ...
    create_valid_test_sounding()
        ...
        .with_mslp(HectoPascal(-1014.0))
        .with_station_pressure(HectoPascal(-847.0))
        .with_sfc_wind(WindSpdDir{ speed_kt: -10.0, direction: 100.0})
}
...
fn create_invalid_test_wind_direction() -> Sounding {
    ...
    create_valid_test_sounding()
        ...
        .with_sfc_wind( WindSpdDir{ direction: -90.0, speed_kt: 5.0})
}
